...
/**
 * The guideController controls the actions in guide interface.
 * This is the controller of guide.fxml file.
 *
 * @author Ke Liu
 */
...
public class guideController {
    ...
    @FXML
    void mouseClickedBackinHelp(MouseEvent event) throws IOException {
    ...
    @FXML
    void mouseEnteredBackinHelp(MouseEvent event) {
        backInHelp.setTextFill(Color.YELLOW);
    }
    ...
    @FXML
    void mouseExitedBackinHelp(MouseEvent event) {
        backInHelp.setTextFill(Color.WHITE);
    }
